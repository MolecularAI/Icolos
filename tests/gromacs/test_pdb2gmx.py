...
class Test_Pdb2gmx(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with open(PATHS_EXAMPLEDATA.GROMACS_DMP_LIGAND_SDF, "r") as f:
            self.dmp_ligand = f.read()
    ...
    def test_pdb2gmx_run(self):
        ...
        step_pdb2gmx._workflow_object = WorkFlow()
    ...
    def test_lig_param_openff(self):
        step_conf = {
            ...
            _SBE.SETTINGS: {
                ...
                _SBE.SETTINGS_ADDITIONAL: {
                    ...
                    "lig_pdb": PATHS_1UYD.NATIVE_LIGAND_PDB,
                    _SOFE.UNIQUE_MOLS: "COc1c(OC)cc(c(Cl)c1OC)Cc(n2)n(CCCC)c(c23)ncnc3N",
                },
            },
        }
        ...
        step_pdb2gmx.data.generic.add_file(
            GenericData(file_name="DMP.sdf", file_data=self.dmp_ligand, argument=True)
        )
        step_pdb2gmx.execute()
        out_path = os.path.join(self._test_dir, "confout.gro")
        step_pdb2gmx.write_generic_by_extension(
